...
public class Ex1_12_2 {
	public static void main(String[] args) {
		...
		*/
		...
		if (receiveNumber < 0 || receiveNumber == 0 || receiveNumber == 1) { //receiveNumberがNGパターンに該当する場合

			System.out.println(" 「適切な値を入力してください」 ");

		} else {

			while (calcNumber < 100) { //100未満のもののみを表示する

				System.out.println("calcNumber：" + calcNumber);

				calcNumber *= receiveNumber; //引数で受け取った数字の累乗の数
